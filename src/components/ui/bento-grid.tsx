...
const BentoCard = ({
  ...
  // Add client-side only click handler
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0 transform-gpu transition-all duration-300 group-hover:bg-zinc-800/50" />
    </div>
  );
};
